...
public class RightButton : MonoBehaviour
{
    ...
    private void Update()
    {
        if (StateManager.nowGameStateProperty.Value == E_GameState.InGame_Ready && SelectingBlock.GetBlock != null && !SelectingBlock.GetBlock.GetComponent<IBlockAction>()._isMaxPattern)
        {
